 ...
 * 
 */
@WebServiceClient(name = "KPSPublic", targetNamespace = "http://tckimlik.nvi.gov.tr/WS", wsdlLocation = "file:/C:/java/tobeto/workspace/KPSOrnek/src/KPSPublic.xml")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/java/tobeto/workspace/KPSOrnek/src/KPSPublic.xml");
